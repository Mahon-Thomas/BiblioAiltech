...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    CustomAdapter(Activity activity, Context context, ArrayList livre_id, ArrayList livre_titre, ArrayList livre_auteur, ArrayList livre_genre, ArrayList livre_disponibilite){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ModifActivity.class);
                ...
                intent.putExtra("genre", String.valueOf(livre_genre.get(position)));
                intent.putExtra("disponibilite", String.valueOf(livre_disponibilite.get(position)));
